...
DIV2K_train_LR_bicubic=$(ls $DATADIR'/datasets/DIV2k/DIV2K_train_LR_bicubic' | grep X2)
...
DIV2K_train_LR_bicubic=$(ls $DATADIR'/datasets/DIV2k/DIV2K_train_LR_bicubic' | grep X4)
if [ "$DIV2K_train_LR_bicubic" == '' ]; then
...
## DIV2K train LR bicubic x8
DIV2K_train_LR_bicubic=$(ls $DATADIR'/datasets/DIV2k/DIV2K_train_LR_bicubic' | grep X8)
if [ "$DIV2K_train_LR_bicubic" == '' ]; then
...
## DIV2K train LR bicubic x2
DIV2K_valid_LR_bicubic=$(ls $DATADIR'/datasets/DIV2k/DIV2K_valid_LR_bicubic' | grep X2)
...
DIV2K_valid_LR_bicubic=$(ls $DATADIR'/datasets/DIV2k/DIV2K_valid_LR_bicubic' | grep X4)
if [ "$DIV2K_valid_LR_bicubic" == '' ]; then
